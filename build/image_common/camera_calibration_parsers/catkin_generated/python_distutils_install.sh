...
echo_and_run cd "/home/nvidia/catkin_ws/src/image_common/camera_calibration_parsers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/nvidia/catkin_ws/src/image_common/camera_calibration_parsers/setup.py" \
    build --build-base "/home/nvidia/catkin_ws/build/image_common/camera_calibration_parsers" \
    install \
    $DESTDIR_ARG \
